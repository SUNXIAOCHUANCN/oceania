...
public class BookPro : MonoBehaviour
{
    ...
    public void OnMouseDragRightPage()
    {
        if (interactable && !tweening)
        {
            ...
            DragRightPageToPoint(transformPointMousePosition(mousePosition));
        }
    ...
    public void OnMouseDragLeftPage()
    {
        if (interactable && !tweening)
        {
            ...
            DragLeftPageToPoint(transformPointMousePosition(mousePosition));
        }
    ...
    public void UpdateBook()
    {
        ...
        */
        ...
        // 将Vector2转换为Vector3
        Vector3 mousePos3D = new Vector3(mousePosition.x, mousePosition.y, 0);
        f = Vector3.Lerp(f, transformPointMousePosition(mousePos3D), Time.deltaTime * 10);
